...
//        assert ((long) a + (long) b) < Integer.MAX_VALUE : "Переполнение";
//        return a + b;
//    }
//
//    // 1.4
...
//        Assertions.assertThat(sum(2, 3)).isEqualTo(5);
//    }
//
//    // 1.7
...
//
//        Assertions.assertThat(emmett.getName()).isEqualTo("Emmett");
//        Assertions.assertThat(emmett.getArmorStrength()).isEqualTo(50);
//        Assertions.assertThat(emmett.getWeapon()).isEqualTo("sword");
//        Assertions.assertThat(emmett.getBag())
//                .isNotEmpty()
//                .hasSize(3)
//                .contains("Bow", "Axe", "Gold");
//        Assertions.assertThat(emmett.isHuman()).isTrue();
//
//
//
//
